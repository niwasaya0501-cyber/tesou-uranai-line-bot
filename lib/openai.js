...
すべての画像において、手が全く写っていない、手のひらではなく手の甲や指先だけが写っている、あるいは手とは全く関係のない画像である場合に限り、他の文章は一切書かず「手のひら全体が写った写真をもう一度送ってください」とだけ返してください。`;
}

async function readPalm(imagesBase64, worryKey) {
...
async function continueChat({ readingText, worry, turns, userMessage }) {
  const worryLabel = WORRY_LABELS[worry] || WORRY_LABELS.other;
...
module.exports = { readPalm, continueChat, WORRY_LABELS };
